	...
	if (isset($_POST['term']) === true) {
		...
		if (isset($_POST['name']) && !empty($_POST['name'])) {
			...
			if (preg_match('/^[A-Za-z\s]+$/', $_POST['name'])) {
				...
				<strong>Only for lower and upper case and characters are allowed</strong>
		...
		if (isset($_POST['blood_group']) && !empty($_POST['blood_group'])) {
			...
			<strong>Please select Bloodgroup</strong>
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>';
		...
		if (isset($_POST['contact_no']) && !empty($_POST['contact_no'])) {
			...
			if (preg_match('/\d{11}/', $_POST['contact_no'])) {
				...
				<strong>Contact should consist 11 characters.</strong>
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
				  <span aria-hidden="true">&times;</span>
				</button>
			  </div>';
		...
		if (isset($_POST['password']) && !empty($_POST['password']) &&  isset($_POST['c_password']) && !empty($_POST['c_password'])) {
			...
			if (strlen($_POST['password']) >= 6) {
				...
				$passwordError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
				<strong>Password should be more than 6 characters</strong>
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
				  <span aria-hidden="true">&times;</span>
				</button>
			  </div>';
		...
		<strong>Please agree with terms and condition</strong>
		<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		  <span aria-hidden="true">&times;</span>
		</button>
	  </div>';
		...
		<div class="col-md-6 offset-md-3 form-container">
			...
			<form class="form-group" action="" method="post" novalidate="">
				...
				<div class="form-group">
					...
					<input type="text" name="contact_no" placeholder="07********" class="form-control" required pattern="^\d{11}$" title="11 numeric characters only" maxlength="11" value="<?php
